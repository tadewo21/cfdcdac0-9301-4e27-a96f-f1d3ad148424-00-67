...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-glow shadow-primary hover:shadow-lg",
        destructive:
        ...
        hero: "bg-gradient-primary text-white shadow-primary hover:shadow-xl hover:scale-105 border-0",
        accent: "bg-gradient-accent text-accent-foreground shadow-accent hover:shadow-lg hover:scale-105",
        apply: "bg-success text-success-foreground hover:bg-success/90 shadow-lg hover:shadow-xl",
      },
      size: {
